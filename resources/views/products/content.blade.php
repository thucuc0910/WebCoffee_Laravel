...
<div class="container p-t-80">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        <a href="/" class="stext-109 cl8 hov-cl1 trans-04" style="font-weight: bold;">
            Home
            <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
        </a>

        <a href="/danh-muc/{{ $product->menu->id }}-{{ Str::slug($product->menu->name) }}.html" class="stext-109 cl8 hov-cl1 trans-04" style="font-weight: bold;">
            {{ $product->menu->name }}
            <i class="fa fa-angle-right m-l-9 m-r-10" aria-hidden="true"></i>
        </a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-5 p-b-30">
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                            ...
                            <div class="size-204 flex-w flex-m respon6-next">
                                <form action="/add-cart" method="post">
                                    ...
                                    @if ($product->price !== NULL)
                                        <div style="padding-left: 0px ;font-size:20px">Số lượng:</div>
                                        <div class="wrap-num-product flex-w m-r-20 m-tb-10">
                                            <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                                                <i class="fs-16 zmdi zmdi-minus"></i>
                                            </div>

                                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num_product" value="1" max="10">
                                        ...
                                        <button type="submit" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 " style="background-color: rgb(13, 89, 40); width:500px">
                                            Thêm vào giỏ hàng
                                        </button>
                    ...
                    <!--  -->
                    <!-- <div class="flex-w flex-m p-l-100 p-t-40 respon7" style="padding-left:0px; padding-top: 10px; font-size:500px;">
        ...
        <div class="bor10 m-t-50 p-t-43 p-b-40">
            ...
            <div class="tab01">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item p-b-10">
                        <a class="nav-link" data-toggle="tab" href="#information" role="tab">Nguyên Liệu</a>
                    </li>
